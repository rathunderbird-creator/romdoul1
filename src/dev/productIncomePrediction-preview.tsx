// Dev-only preview: open http://localhost:5173/dev/productIncomePrediction.html
// while `npm run dev` is running.
//
// Mounts the pure ProductIncomePredictionView with fixture data — no auth,
// no store, no Supabase. A slim grey bar on top switches scenario / language
...
const Preview = () => {
    ...
    const data = useMemo<ProductIncomeData>(() => ({
    ...
    return (
        <>
            <div style={devBarStyle}>
                <strong>Prediction by Product preview</strong>
                <label>
                    scenario{' '}
