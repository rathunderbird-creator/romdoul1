        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    return [4 /*yield*/, itemQuery.limit(200)];
                case 1:
                    _a = _b.sent(), itemMatches = _a.data, itemError = _a.error;
                    console.log("Item Matches:", itemMatches === null || itemMatches === void 0 ? void 0 : itemMatches.length, "Error:", itemError);
